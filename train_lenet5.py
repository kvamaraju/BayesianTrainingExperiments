...
parser.add_argument('--thres_std', nargs='*', type=float, default=[0.2, 0.2, 0.5, 1.0])
...
def main():
    ...
    # create model
    model = LeNet5(10, type_net=args.type_net, N=60000, beta_ema=args.beta_ema, dof=args.dof)
