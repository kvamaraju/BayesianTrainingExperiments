...
parser = argparse.ArgumentParser(description='PyTorch BaseCNN Training')
...
parser.add_argument('--name', default='BaseCNN', type=str,
                    help='name of experiment')
parser.add_argument('--tensorboard',
                    help='Log progress to TensorBoard', action='store_true')
parser.add_argument('--multi_gpu', action='store_true')
parser.add_argument('--thres_std', nargs='*', type=float, default=[0.2, 0.2, 0.2, 0.2, 0.5, 1.0])
...
parser.add_argument('--anneal_type', choices=['kl', 'entr'], default='kl')
...
def main():
    ...
    # create model
    model = BaseCNN(10, model_size=1, type_net=args.type_net, N=50000, beta_ema=args.beta_ema)
